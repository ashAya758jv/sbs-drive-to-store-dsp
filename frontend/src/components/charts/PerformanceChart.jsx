...
/** French thousands separator (narrow no-break space). */
...
/**
 * Dual-axis performance trend: impressions (left) and clics (right). The two
 * metrics live on very different scales, hence the second Y axis.
 */
