    ...
    <aside className="sticky top-0 flex h-screen w-[260px] shrink-0 flex-col border-r border-slate-200/70 bg-white">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                ...
                isActive
                  ? "bg-primary-50 text-primary-700 active:bg-primary-100"
      ...
      <div className="border-t border-slate-100 p-3">
        <button
          type="button"
          onClick={logout}
          className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-slate-600 transition-colors hover:bg-rose-50 hover:text-rose-600 active:bg-rose-100"
        >
