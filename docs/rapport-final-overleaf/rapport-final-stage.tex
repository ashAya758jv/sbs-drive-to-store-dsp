...
% Chemins d'images relatifs à la racine du projet Overleaf (dossier auto-contenu).
...
%--------------------------- Page de garde ------------------------------------
\input{sections/00-page-garde}

%--------------------------- Pages liminaires ---------------------------------
\pagenumbering{roman}
\setcounter{page}{1}

\input{sections/01-remerciements}
\input{sections/02-resume-abstract}
...
\input{sections/04-organisme-accueil}
\input{sections/05-problematique-objectifs}
\input{sections/06-methodologie}
\input{sections/07-analyse-fonctionnelle}
\input{sections/08-architecture-technique}
\input{sections/09-conception-base-donnees}
\input{sections/10-realisation-modules}
\input{sections/11-tests-validation}
\input{sections/12-documentation-livraison}
\input{sections/13-limites-perspectives}
\input{sections/14-conclusion}

%--------------------------- Bibliographie ------------------------------------
\input{sections/16-bibliographie}
